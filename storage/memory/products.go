...
func (b *productRepo) GetProduct(req models.IdRequestProduct) (resp models.Product, err error) {
	products, err := b.read()
	if err != nil {
...
func (b *productRepo) DeleteProduct(req models.IdRequestProduct) (string, error) {
	products, err := b.read()
	if err != nil {
		return "", err
	}
...
func (b *productRepo) GetListProduct() (resp models.GetAllProduct, err error) {
	products, err := b.read()
	if err != nil {
		return resp, err
	}
